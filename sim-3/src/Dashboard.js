...
class Dashboard extends Component {
    ...
    render() {
        const { user, picture, firstName, lastName } = this.props;
        return (
            <div>
                {user && 
                <div>
                ...
                <div className='top-boxes'> {/* top two boxes*/}
                    <div className='content-div1'>
                        <div><img src={picture} alt='pict' className='image'/></div>
                        <div>
                            <div>{firstName}</div>
                            <div>{lastName}</div>
                ...
                <div className='bottom-box'> {/* bottom box*/}
                    <div>
                        Recommended Friends
                    </div>
