...
import { login, updateName, updateLastName } from './ducks/reducer';
...
class Profile extends Component {
    ...
    render() {
        const { user, updateName, updateLastName } = this.props;
        return (
            <div>
                {user && 
                <div>
                    ...
                    <div>
                        ...
                        <div className='profile-bottom-box'>
                            ...
                            Last Name
                            <input onChange={(event) => updateLastName(event.target.value)} />
                            Gender
                            <input />
                            Hair Color
                            <input />
...
export default connect(mapStateToProps, { login, updateName, updateLastName })(Profile);
